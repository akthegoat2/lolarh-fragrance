...
export default function Hero() {
  return (
    <section className="relative bg-gradient-to-br from-pink-50 via-rose-50 to-pink-100 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-32 lg:py-40">
        <div className="max-w-2xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <Link
              href="/shop"
              className="inline-flex items-center justify-center px-8 py-3.5 bg-gradient-to-r from-rose-500 to-pink-500 text-white font-semibold rounded-full shadow-lg shadow-rose-200 hover:shadow-xl hover:shadow-rose-300 hover:scale-105 transition-all duration-300 text-sm md:text-base"
            >
              Shop Now
            ...
            <Link
              href="/contact"
              className="inline-flex items-center justify-center px-8 py-3.5 bg-white text-gray-700 font-semibold rounded-full border border-pink-200 hover:border-pink-300 hover:bg-pink-50 transition-all duration-300 text-sm md:text-base"
            >
              Get In Touch
            </Link>
          </div>
      ...
      <div className="absolute -bottom-6 -right-6 w-64 h-64 md:w-96 md:h-96 rounded-full bg-gradient-to-br from-pink-200/20 to-rose-300/20 blur-3xl" />
      <div className="absolute -top-10 -left-10 w-48 h-48 md:w-72 md:h-72 rounded-full bg-gradient-to-br from-pink-200/20 to-purple-200/10 blur-3xl" />
    </section>
  );
}
